...
@ComponentScan(basePackages = {"com.intiformation.gestion.immo"})// détection auto des beans spring
public class BackGestionImmobiliereApplication {
	 ...
	 * @param pDataSource à injecter dans la sessionFactory
	 * @return
	 * @throws IOException 
	 */
	@Autowired
	...
	/**
	 * permet de créer un bean spring du gestionnaires des txs 
	 * injection du bean de la sessionFactory
	 * @return
	 */
	@Autowired
